...
class Base2 {
public:
    virtual int func2(int) throw(int);
...
public:
    int func2(int) throw(int);

    string func3() throw(int, string);
};

int Derived2::func2(int) throw(int) {
    return 0;
}

string Derived2::func3() throw(int, string) {
    return "11";
}

#define C__DEMO_CEXCEPTION_H

#endif //C__DEMO_CEXCEPTION_H
